          ...
          <div className="bg-gray-50 rounded-lg p-8 max-w-3xl mx-auto">
            <div className="space-y-4 text-center">
              ...
              <div>
                ...
                <a href="mailto:info@1stchoiceproperties.com.ng" className="text-green-600 hover:text-green-700">
              ...
              <div>
                ...
                <div className="space-y-1">
                  <a href="tel:08080361789" className="text-gray-600 hover:text-gray-900 block">
                    08080361789
                  </a>
                  <a href="tel:08130992077" className="text-gray-600 hover:text-gray-900 block">
                    08130992077
                  </a>
                </div>
              </div>
